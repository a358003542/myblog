...
Modified: 2017-11-14 14:37
[TOC]

## 第二版说明

在 [第一版中]({static}./小分子网页显示.html) 我们介绍了在html文件中如何绘制数学表达式和化学分子式，简单来说就是利用 `mathjax`  这个javascript库。但是我们是如此喜欢markdown和pelican，那里在pelican下该如何做呢。
