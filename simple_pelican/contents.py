...
from simple_pelican.settings import DEFAULT_CONFIG
from simple_pelican.utils import (SafeDatetime, deprecated_attribute, memoized,
...
from simple_pelican.urlwrappers import (Author, Category, Tag, URLWrapper)  # NOQA
